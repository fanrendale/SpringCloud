...
public class HouseClientController {
     ...
     * @return
     */
    @GetMapping("/call/byName")
    public HouseInfo getData4(@RequestParam("id") String id){
        return restTemplate.getForObject("http://ribbon-config-demo/house/data?id=" + id, HouseInfo.class);
    }
}
